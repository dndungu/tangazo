	...
	<div class="container">
		<div class="header row">
			...
			<ul class="column grid10of10">
				...
				<li><a href="subSections.php">Brands</a></li>
				<li><a href="media.php">Media</a></li>
				<li><a href="sections.php">Sections</a></li>
				<li><a href="subSections.php" class="current">Sub Sections</a></li>
			</ul>
		</div>
		<div class="content">
			<div class="gridColumns">
				<div class="row">
					<div class="column grid1of10 align-center">
						<input type="button" id="deleteRecords" name="subSection" value="DELETE"/>
					</div>
				</div>			
				<div class="column grid1of10 align-center">
			...
			$query[] = sprintf("ORDER BY `subSection`.`name` ASC, `subSection`.`ID` DESC LIMIT %d, %d", $offset, $config['PAGE_SIZE']);
