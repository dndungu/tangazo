...
// 			$title = 'WEEK ' . date('W, Y', $t);
			$title = '<input type="text" name="week" value="'.weekOfMonth($t).'" size="1"/>';
			$title .= '<input type="text" name="month" value="'.date('n', $t).'" size="2"/>';
			$title .= '<input type="text" name="year" value="'.date('Y', $t).'" size="4"/>';
